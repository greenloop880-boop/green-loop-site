      ...
      <div className="container cta-inner">
        <div className="fade-up">
          ...
          <div className="cta-actions" style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: '1rem', flexWrap: 'nowrap', overflowX: 'auto' }}>
            <a href="tel:+91-XXXXXXXXXX" className="btn btn--gold" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '3.5rem', height: '3.5rem', padding: '0', borderRadius: '50%', fontSize: '1.5rem', boxShadow: "none" }}>📞</a>
            <a href="https://wa.me/91XXXXXXXXXX" className="btn btn--outline-light" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '3.5rem', height: '3.5rem', padding: '0', borderRadius: '50%', fontSize: '1.5rem' }}>💬</a>
