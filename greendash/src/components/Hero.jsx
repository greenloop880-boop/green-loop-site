      ...
      <div className="container hero-content-top">
        <div className="hero-text-side">
          ...
          <p className="hero-sub">
            VELORA fans, powered by Velotech Innovations — India's most energy-efficient BLDC ceiling fans.
            And Green Loop, our flagship initiative that turns your old fan into carbon credits,
            putting money back in your pocket and CO₂ back in the ground.
          </p>
          <div className="hero-actions">
            <a href="#products" className="btn btn--gold">Explore VELORA Fans ↓</a>
        ...
        <div className="hero-image-side">
          <img src="/images/velora_official_fan.png" alt="Velora Smart Fan" className="hero-main-img" />
        </div>
      </div>
      ...
      <div className="container hero-bento-grid">
        ...
        <div className="bento-box stats-box">
          <div className="bento-stat">
            ...
            <div className="lbl">VELORA FAN WATTAGE</div>
          </div>
          ...
          <div className="divider-v"></div>
          <div className="bento-stat">
            <div className="icon" style={{color: 'var(--gold)'}}>₹0</div>
            <div className="val" style={{color: 'var(--gold)'}}>UPFRONT</div>
            <div className="lbl" style={{color: 'var(--gold)'}}>INSTANT KARO</div>
          </div>
        </div>
        ...
        <div className="bento-box how-box">
          ...
          <div className="how-steps">
            <div className="h-step">
              ...
              <div className="h-lbl">Install<br/>Velora Fan</div>
            </div>
