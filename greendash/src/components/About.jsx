    ...
    <div className="container">
      <div className="about-grid">
        ...
        <div className="fade-up">
          ...
          <h2 className="display">Built at IIT Bhubaneswar. <em>Built for India.</em></h2>
          <p className="lead" style={{marginBottom: '2rem'}}>Velotech Innovations is a technology company founded at IIT
          ...
          <div className="mission-points">
            <div className="mission-point">
              ...
              <div>
                ...
                <p>A range of BLDC ceiling fans engineered for Indian homes — silent, powerful, remote-controlled, and
            ...
            <div className="mission-point">
              ...
              <div>
                ...
                <p>India's first fully integrated fan circular economy. We buy back your old fan, refurbish it, and turn
            ...
            <div className="mission-point">
              ...
              <div>
                ...
                <p>We work through RWA/AOA communities, local dealers, and Hyper-Local Hubs — bringing the service to
